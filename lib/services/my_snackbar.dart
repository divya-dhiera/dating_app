...
class GetBar extends GetSnackBar {
  const GetBar({
    ...
    SnackPosition snackPosition = SnackPosition.bottomCenter,
    SnackStyle snackStyle = SnackStyle.floating,
    EdgeInsets? mainMargin,
...
class GetSnackBar extends StatefulWidget {
  ...
  /// [snackPosition] == [SnackPosition.bottomCenter] and [DismissDirection.up]
  /// when [snackPosition] == [SnackPosition.topCenter]
  ...
  /// Snack can be based on [SnackPosition.topCenter] or on [SnackPosition.bottomCenter]
  /// of your screen.
  /// [SnackPosition.bottomCenter] is the default.
  ...
  const GetSnackBar({
    ...
    this.snackPosition = SnackPosition.bottomCenter,
...
class GetSnackBarState extends State<GetSnackBar> with TickerProviderStateMixin {
  ...
  final double _finalOpacity = 0.6;
  ...
  Widget build(BuildContext context) {
    return Container(
        margin: widget.mainMargin ??
            EdgeInsets.only(
              left: widget.snackPosition == SnackPosition.bottomLeft || widget.snackPosition == SnackPosition.topLeft ? 10.0 : 0.0,
              top: widget.snackPosition == SnackPosition.topCenter || widget.snackPosition == SnackPosition.topLeft || widget.snackPosition == SnackPosition.topRight ? 10.0 : 0.0,
              right: widget.snackPosition == SnackPosition.bottomRight || widget.snackPosition == SnackPosition.topRight ? 10.0 : 0.0,
              bottom: widget.snackPosition == SnackPosition.bottomLeft || widget.snackPosition == SnackPosition.bottomCenter || widget.snackPosition == SnackPosition.bottomRight
                  ? 10.0
                  : 0.0,
            ),
        child: Align(
          alignment: widget.snackPosition == SnackPosition.bottomLeft
              ? Alignment.bottomLeft
              : widget.snackPosition == SnackPosition.bottomRight
              ? Alignment.bottomRight
              : widget.snackPosition == SnackPosition.bottomCenter
              ? Alignment.bottomCenter
              : widget.snackPosition == SnackPosition.topRight
              ? Alignment.topRight
              : widget.snackPosition == SnackPosition.topLeft
              ? Alignment.topLeft
              : widget.snackPosition == SnackPosition.topCenter
              ? Alignment.topCenter
              : Alignment.center,
          heightFactor: 1.0,
          child: Material(
            ...
            child: SafeArea(
              minimum: widget.snackPosition == SnackPosition.bottomCenter
                  ? EdgeInsets.only(bottom: MediaQuery.of(context).viewInsets.bottom)
                  : EdgeInsets.only(top: MediaQuery.of(context).padding.top),
              bottom: widget.snackPosition == SnackPosition.bottomCenter,
              top: widget.snackPosition == SnackPosition.topCenter,
              left: false,
              right: true,
              child: Stack(
                children: [
...
enum SnackPosition { topCenter, topRight, topLeft, bottomLeft, bottomRight, bottomCenter }
...
class SnackbarController {
  ...
  void _configureAlignment(SnackPosition snackPosition) {
    switch (snackbar.snackPosition) {
      ...
      case SnackPosition.bottomCenter:
  ...
  DismissDirection _getDefaultDismissDirection() {
    if (snackbar.snackPosition == SnackPosition.topCenter) {
...
SnackbarController snackbar(
  ...
  final getSnackBar = GetSnackBar(
      ...
      snackPosition: snackPosition ?? SnackPosition.topCenter,
